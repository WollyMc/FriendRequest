...
public class ProfileActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mFriendReqDatabase = FirebaseDatabase.getInstance().getReference().child("Friend_req"); //Creates a new node in DB
        ...
        mUsersDatabase.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                Picasso.with(ProfileActivity.this).load(image).placeholder(R.drawable.ic).into(mProfileImage);


                // ------------------------------>Friend list and request
                ...
                mFriendReqDatabase.child(mCurrent_user.getUid()).addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        if(dataSnapshot.hasChild(user_id))
                        {
                            ...
                            {
                                //mProfileSendReqBtn.setEnabled(true); will be true
        ...
        mProfileSendReqBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mProfileSendReqBtn.setEnabled(false); //After User Taps it won't work

                //check and send request if not friend ------------------------------>
                ...
                if (mCurrent_state.equals("not_friends"))
                {
                    ...
                    }); //inside child is the user we are browsing
                }
